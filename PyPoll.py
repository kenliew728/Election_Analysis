...
with open(file_to_load) as election_data:
    ...
    headers = next(file_reader) #print(headers) to confirm header will be ignored
...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        # To do: print out each candiate's name, vote count, and percentage of vote to the terminal
    ...
    # Save the winning candidate's name to the text tile
